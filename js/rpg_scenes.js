...
Scene_Title.prototype.createBackground = function() {
    ...
    this._backSprite1 = new Sprite(ImageManager.loadTitle1('Book'));//$dataSystem.title1Name
    this._backSprite2 = new Sprite(ImageManager.loadTitle2('Floral'));//$dataSystem.title2Name
